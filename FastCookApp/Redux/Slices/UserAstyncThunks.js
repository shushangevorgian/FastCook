...
import { SetToken,SetDataLogin, SetDataForgotPass, SetDataSignUp, SetDataConfirmCode } from '../Links/AsyncStorage';
import { SignUpRequest, VaerifyCodRequest } from '../Links/LinkForSignUp';
import { createNewPassRequest, forgotConfirmRequest, forgotPassRequest } from '../Links/LinkForForgotPassword';
...
export const ConfirmForgotCode = createAsyncThunk('user', async function(data){
...
///////////////?????????????
export const CreateNewPassLogin = createAsyncThunk('user', async function(data){
