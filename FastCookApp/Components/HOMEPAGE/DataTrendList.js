...
export const renderTrendListData = (style = {borderRadius: 30}) => {
    return [
        ...
        },
        {
            ...
            image: <View  style={style}><Image 
            style={style}
            source={require('./ImagesForTrendData/img1.png')} /></View>
        },
        {
            id:2,
            title: "Microwave Sweet Potato",
            ...
            image: <View  style={style}><Image 
            style={style}
            source={require('./ImagesForTrendData/img7.jpg')} /></View>
        },
        {
            id:3,
            title: "Microwave Sweet Potato",
            ...
            image: <View  style={style}><Image 
            style={style}
            source={require('./ImagesForTrendData/img3.png')} /></View>
        },
        {
            id:4,
            title: "Microwave Sweet Potato",
            ...
            image: <View  style={style}><Image 
            style={style}
            source={require('./ImagesForTrendData/img4.png')} /></View>
        }
    
    ]
}

export const renderTrendListData2 = (style = {borderRadius: 30}) => {
    return [
        {
            id:0,
            title: "Microwave Sweet Potato",
            ...
            image: <View  style={style}><Image 
            style={style}
            source={require('./ImagesForTrendData/img8.jpg')} /></View>
            // image: './ImagesForTrendData/Potato.png'
        },
        {
            id:1,
            ...
            image: <View  style={style}><Image 
            style={style}
            source={require('./ImagesForTrendData/img6.jpg')} /></View>
        },
        {
            id:2,
            title: "Microwave Sweet Potato",
        ...
        },
        {
            ...
            image: <View  style={style}><Image 
            style={style}
            source={require('./ImagesForTrendData/img10.jpg')} /></View>
        },
        {
            id:5,
            title: "Microwave Sweet Potato",
            ...
            image: <View  style={style}><Image 
            style={style}
            source={require('./ImagesForTrendData/img9.jpg')} /></View>
        }
